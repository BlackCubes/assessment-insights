...
from apps.academics.services import CreateStudentPeriodEnrollmentData, UpdateStudentPeriodEnrollmentData, create_student_period_enrollment, update_student_period_enrollment
from apps.students.models import Student

class StudentPeriodEnrollmentSerializer(serializers.ModelSerializer[StudentPeriodEnrollment]):
    student = serializers.SlugRelatedField(slug_field="uuid", queryset=Student.objects.all())
    period = serializers.SlugRelatedField(slug_field="uuid", queryset=Period.objects.all())
    ...
    class Meta:
        ...
        fields = ["uuid", "student", "period", "term", "is_current", "created_at", "updated_at"]
    ...
    def update(self, instance: StudentPeriodEnrollment, validated_data: dict[str, Any]) -> StudentPeriodEnrollment:
        try:
